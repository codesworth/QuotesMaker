...
class Subscription{
    ...
    enum Name:String {
        ...
        noSub,stateChange,roundedCornerRadiusValueChanged,moreFonts, purchaseNotification, failedPurchase, showXCrossHairs,showYCrossHairs,unshowYCrossHairs,unshowXCrossHairs,unshowAllCrossHairs
    }
